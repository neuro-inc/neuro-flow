...
Contains outputs generated by tasks that were specified in the [`tasks.needs`](batch-workflow-syntax.md#tasks-needs) attribute. Refer to [`set-output` command](batch-workflow-commands.md#set-output-command) reference to learn how to generate outputs.
